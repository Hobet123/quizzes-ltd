...
@section('content')
    <header class="header">
        <h1>Upload Json Quiz:</h1>
    </header>
    <form action="/admin/doUploadJson" method="post" enctype="multipart/form-data" class="">
        @csrf
        ...
        <div class="form-group form-control">
            <label for="cover_image">Json</label>
            <input type="file" name="json" value="{{ old('json') }}" />
        </div>
        <div class="form-group form-control">
