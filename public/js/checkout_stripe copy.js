...
async function initialize() {
  const { clientSecret } = await fetch("/payment_intent", {
    method: "POST",
    headers: {
...
async function checkStatus() {
  const clientSecret = new URLSearchParams(window.location.search).get(
    "sk_test_51MrHitIa7Ttd6va4E0bjJ3ObasuT9QqXDiAJOv8nf3ajz8rIIyJwjqpJvx37kX05Cf9ZJSXXx2GylkuUZtKvXzhw00h9Xiqv8x"
  );
